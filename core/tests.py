...
class CoreViewsTests(TestCase):
    ...
    def test_item_detail_records_public_visit_and_shows_sparkline(self):
        ...
        self.assertContains(response, 'title="Imprescindible"')
    ...
    def test_authenticated_viewer_can_rate_other_user_item(self):
        ...
        self.assertContains(response, "Imprescindible")
        self.assertContains(response, "Conspiratiu")
        self.assertContains(response, "Dubtós")
        self.assertContains(response, "Spam/Fals")
        self.assertNotContains(response, "Must")
        self.assertNotContains(response, "Necessari")
        self.assertNotContains(response, "Discutible")
        self.assertNotContains(response, "No és per mi")
